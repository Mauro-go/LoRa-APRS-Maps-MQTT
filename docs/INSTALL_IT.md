...
# 7.1 Permessi dei file

Prima dei test manuali e prima di avviare i servizi systemd, verificare
i permessi dei file Python.
...
Non esiste un limite software prefissato al numero di ricevitori.

Per aggiungerne uno è sufficiente aggiungere una voce:
